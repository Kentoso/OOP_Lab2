...
public partial class MainViewModel : ObservableObject
{
    ...
    private void SaveHtml()
    {
        ...
        transform.Load(@"C:\Users\Demian\RiderProjects\LabXML\LabXML\Dataset\output.xsl");
        StringWriter results = new StringWriter();
        XmlReader xmlStringReader = XmlReader.Create(new StringReader(xml));
        transform.Transform(xmlStringReader, null, results);
        File.WriteAllText(@"C:\Users\Demian\RiderProjects\LabXML\LabXML\Dataset\abc.html", results.ToString());
    }
    ...
    {
        sourcePath = @"C:\Users\Demian\RiderProjects\LabXML\LabXML\Dataset\supermarket_sales - Sheet1 (3).xml";
